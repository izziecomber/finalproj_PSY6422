...
# Warning message about use of other colour palette 
# Dynamically generate a colour palette
dynamic_colors <- colorRampPalette(RColorBrewer::brewer.pal(8, "Set2"))(length(unique(totals_by_region$Region)))
